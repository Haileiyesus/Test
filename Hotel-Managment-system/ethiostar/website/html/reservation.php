...
<?php				
  ...
  <tr>
    ...
    <td align="left"><input name="sex" type="radio" value="Male"> Male  &nbsp;&nbsp;
    <input name="sex" type="radio" checked="checked" value="Female"> Female</td>
  </tr>
  <tr>
...
mysql_select_db("ethiostar",$con);
$sql="select room_no,room_type,detail from rooms where floor_no = $preference && status = 'free'";
$result = mysql_query($sql,$con);
If(!$result)
	die("unable to query:");
	echo "<span class='style11'><caption>Room Results</caption></span><table border='1'><tr class='style15'><th>Room No.</th><th>Room Type</th><th>Room Detail</th></tr>";
