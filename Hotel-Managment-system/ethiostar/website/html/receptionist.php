...
$sql="select password, username from accounts where role='receptionist'";
...
<table width="659" border="0">
  <tr>
    ...
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Book<br> Reservation </span> </p>      </td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Cancel<br> Reservation  </span> </p></td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Update<br> 
      Reservation </span> </p></td>
  </tr>
  <tr>
    ...
    <td width="195" align="center" background="images/photo_bg.gif">
      <p> 
        </span><span class="style17"><span class="style18">Generate<br> 
        Report </span></span> </p></td>
  </tr>
</table>
		  ...
		  <div id="photogallery">
			  ...
			  <span class="style11 style12"> Welcome <a href="receptionist.php" class="style11 style12">'; echo strtoupper($username); echo'</a></span>
			    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/hrm/hanna.jpeg" width="110" height="140"></p>
			    <p><span class="style15">Ms. Hanna Kebede </span><span class="style16">System Admin of Ethio-star Hotel</span> </p>
			  </div>
