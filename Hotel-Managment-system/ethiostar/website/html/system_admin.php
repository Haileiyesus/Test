...
$sql="select password, username from accounts where role='system_admin'";
...
mysql_close($con);
	...
	<div id="content">
		...
		<div id="sidebar2">
		    <p class="style11"><span class="style12">You are here:</span> <a href="index.php" class="style12">Home</a> <img src="images/arrow.gif"> <span class="style13">System Administrator  </span>	      </p>
		    <p class="style11">&nbsp;</p>
		    <div class="block"></div>
		  <p><span class="style10">Menu:</span><br>
<table width="659" border="0">
  <tr>
    <td width="63" height="115" align="center"><img src="images/white.jpg" alt="view comment" width="65" height="47"></td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Add Room</span> </p>
      </td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Delete Room </span> </p></td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Update<br> Room</span> </p></td>
  </tr>
  <tr>
    <td width="63" height="115" align="center"><img src="images/white.jpg" alt="view comment" width="65" height="47"></td>
    <td width="195" align="center" background="images/photo_bg.gif"><p>
      <p><span class="style17">Add<br> Employee </span> </p>
      </p></td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Update<br> 
        Employee </span> </p></td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p><span class="style17">Terminate Employee</span> </p></td>
  </tr>
  <tr>
    <td width="63" align="center"><img src="images/white.jpg" alt="view comment" width="65" height="47"></td>
    <td width="195" align="center"><a href="view_comments.php"><img src="images/white.jpg" alt="view comment" width="178" height="120" border="0"></a></td>
    <td width="195" align="center" background="images/photo_bg.gif">
      <p> 
        </span><span class="style19"><span class="style18">Change<br> Hotel Profile</span></span> </p></td>
		  ...
		  </div><div id="photogallery">
			  <div class="photos2">				<span class="style11 style12"> Welcome <a href="system_admin.php" class="style11 style12">'; echo strtoupper($username); echo'</a></span>

			    <p>&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/hrm/ali.jpg" width="145" height="120"></p>
			    <p><span class="style15">Mr. Ali Hassen </span><span class="style16">System Admin of Ethio-star Hotel</span> </p>
			  </div>
