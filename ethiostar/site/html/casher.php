...
$sql="select password, username from accounts where username='$user' &&  role='casher'";
...
mysql_close($con);
	...
	<div id="content">
		...
		<div id="sidebar2">
		    <p class="style11"><span class="style12">You are here:</span> <a href="index.php" class="style12">Home</a> <img src="images/arrow.gif"> <span class="style13">Casher</span>	      </p>
		    <p class="style11">&nbsp;</p>
		    <div class="block"></div>
		    <p><span class="style10">Menu:</span><br>
<table width="563" border="0">
  <tr>
    <td width="92" align="center"><img src="images/white.jpg" alt="view comment" width="65" height="47"></td>
    <td width="176" align="center"><a href="view_comments.php"><img src="images/generate_button.jpg" alt="view comment" width="178" height="120" border="0"></a></td>
    <td width="15" align="center"><img src="images/white.jpg" alt="view comment" width="44" height="47"></td>
    <td width="176" ><img src="images/view_authorized_button.jpg" alt="permit leave" width="178" height="120"></td>
  </tr>
</table>
		  ...
		  <div id="photogallery">
			  <div class="photos2">	
			  <span class="style11 style12"> Welcome <a href="casher.php" class="style11 style12">'; echo strtoupper($username); echo'</a></span>
			    <p>&nbsp;&nbsp;<img src="images/hrm/yodit.jpg" width="140" height="180"><span class="style15">Ms. Yodit Terefe </span><span class="style16">Casher of Ethio-star Hotel</span> </p>
		      </div>
